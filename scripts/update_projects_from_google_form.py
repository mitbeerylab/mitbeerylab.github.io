...
TITLE_ALIASES = (
    "Title",
    "title",
    "Short Title / Acronym (Ex. INQUIRE)",
    "Short Title / Acronym",
    "Short Title",
    "Acronym",
)
IMAGE_ALIASES = ("Project Logo (square image)", "Project Logo", "Logo", "logo")
DESCRIPTION_ALIASES = ("Description", "description", "Description / Abstract")
...
CAROUSEL_SUMMARY_ALIASES = (
    ...
    "Carousel Summary",
    "carousel_summary",
    "<10 Word Subtitle / Catchphrase / Summary (Ex. A Benchmark for Natural-World Image Retrieval)"
)
